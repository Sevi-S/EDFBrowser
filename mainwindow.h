...
//               *math_func_menu,
    *timemenu,
    ...
    char videopath[MAX_PATH_LENGTH],
...
public slots:
    ...
    void open_new_file();//
    void start_stop_video();  //these three added by sevi
    void close_all_files();

    void print_to_edf();//moved here by sevi
    void set_display_time_whole_rec();
    void sync_by_crosshairs();
    void Escape_fun();

    void load_file_from_save(const char *);
